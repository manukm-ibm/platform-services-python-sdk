...
class TestGetAccountSummary:
    ...
    def test_get_account_summary_required_params_with_retries(self):
        # Enable retries and run test_get_account_summary_required_params.
        _service.enable_retries()
        self.test_get_account_summary_required_params()

        # Disable retries and run test_get_account_summary_required_params.
        _service.disable_retries()
        self.test_get_account_summary_required_params()
